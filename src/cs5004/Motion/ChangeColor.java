...
public class ChangeColor extends AbstractMotion implements IMotion {
  ...
  public String toString() {
    ...
    return String.format("Shape %s changes color from %s to %s from time %d to time %d", this.shape.getName() ,this.start.toString(),
  ...
  public String toSVGString() {
    return String.format("<animate attributeType='xml' begin='%dms' dur='%dms' attributeName='fill' from='%s' to='%s' fill='freeze' />", 
        this.startTime*1000,
