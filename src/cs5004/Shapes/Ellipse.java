...
public class Ellipse extends AbstractShape implements Shape {
  ...
  public Ellipse clone() {
    return new Ellipse(this.reference.clone(), this.color.clone(), this.visible, this.name, this.appearsAt, this.disappearsAt, this.w, this.h);
  }
  ...
  public String toSVGString() {
    ...
    return String.format("<ellipse id='%s' cx='%d' cy='%d' rx='%d' ry='%d' fill='%s' visibility='visible' >***</ellipse>", this.name, this.getPos().getX(), this.getPos().getY(), this.w, this.h, this.color.toString());
  }
